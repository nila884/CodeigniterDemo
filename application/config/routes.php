...
$route['books/tag/(:any)'] = 'books/tag/$1';
$route['comment/create'] = 'books/comment';
$route['cmt/(:any)'] = 'books/cmt/$1';
$route['comments/list/(:any)'] = 'books/list/$1';
$route['books/(:any)'] = 'books/action/$1';
$route['books/edit/(:any)'] = 'books/edit/$1';
$route['books'] = 'books/view';
